...
<body>
	<div class="dropdown" style="text-align: left;">
		...
		<ul class="dropdown-menu">
		    <li><a href="KhachHangServlet?lang=vietnam">VietNam</a></li>
		    <li><a href="KhachHangServlet?lang=english">English</a></li>
		</ul>
	</div>
	<form action="AddKH" method="get">
		<table class="nhap">
			<tr>
				<td style="color: white;">${lang.ten} :</td>
				<td><input type="text" name="TenKH"></td>
			</tr>
			<tr>
				<td style="color: white;">${lang.diaChi} :</td>
				<td><input type="text" name="DiaChi"></td>
			</tr>
			<tr>
				<td style="color: white;">${lang.phuong} :</td>
			...
			<tr>
				<td style="color: white;">${lang.sdt} :</td>
			...
			<tr>
				<td style="color: white;">${lang.soThe} :</td>
			...
			<tr>
				<td style="color: white;">${lang.soTien} :</td>
				<td><input type="text" name="Tien"></td>
			</tr>
		</table>
		<input type="submit" value="${lang.them}" name="luaChon" class="nhap">
	</form>
	<table>
		<tr>
			<th style="color: white;">${lang.maKH}</th>
			<th style="color: white;">${lang.ten}</th>
			<th style="color: white;">${lang.diaChi}</th>
			<th style="color: white;">${lang.phuong}</th>
			<th style="color: white;">${lang.quan}</th>
			<th style="color: white;">${lang.sdt}</th>
			<th style="color: white;">Email</th>
			<th style="color: white;">CMND</th>
			<th style="color: white;">${lang.soThe}</th>
			<th style="color: white;">${lang.soTien}</th>
		</tr>
			...
			<c:choose>
				<c:when test="${i%2 eq 0}">
					<tr class="a">
						...
						<td><a href="DeleteKh?MaKH=${khachHang.maKH}">${lang.xoa}</a></td>
						<td><a href="UpdateKh?MaKH=${khachHang.maKH}">${lang.sua}</a></td>
					</tr>
