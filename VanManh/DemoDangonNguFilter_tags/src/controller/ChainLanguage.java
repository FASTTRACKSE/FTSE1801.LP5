...
public class ChainLanguage implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		/**
		 * Flag nay duoc dung de quyet dinh co tao moi cookie khi khong ton tai cookie
		 * hoac thay doi ngon ngu - true : trang thai cho phep tao moi - false: trang
		 * thai khong cho phep tao moi
		 */
