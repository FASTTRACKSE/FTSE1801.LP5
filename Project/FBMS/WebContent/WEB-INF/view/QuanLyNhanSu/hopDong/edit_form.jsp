					...
					<form:form method="POST" modelAttribute="hopDong" action="">
						...
						<div class="form-group col-sm-6">
							...
							<div class='input-group date datetimepicker10'>
								<form:input type='text' path="ngayKy" value="${hopDong.ngayKy}"
						...
						<div class="form-group col-sm-6">
							...
							<div class='input-group date datetimepicker10'>
								<form:input type='text' path="hopDongTuNgay"
									value="${hopDong.hopDongTuNgay}" placeholder="Ngày cấp"
									class="form-control" />
								<span class="input-group-addon"> <span
									class="fa fa-calendar"></span>
								</span>
						...
						<div class="form-group col-sm-6">
							...
							<div class='input-group date datetimepicker10'>
								<form:input type='text' path="hopDongDenNgay"
									value="${hopDong.hopDongDenNgay}" placeholder="Ngày cấp"
									class="form-control" />
								<span class="input-group-addon"> <span
									class="fa fa-calendar"></span>
								</span>
