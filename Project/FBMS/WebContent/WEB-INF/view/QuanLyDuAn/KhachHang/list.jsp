				...
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a
								href='<c:url value="/QuanLyDuAn/KhachHang/list-khachHang" />'>Danh Sách Khách Hàng</li>
						</ol>
					</div>
				</div>
			</div>
			...
			<div class="x_panel">
				<div class="x_title">
					<a class="btn btn-outline-success round btn-min-width mr-1 mb-1"
						href="<c:url value="/QuanLyDuAn/KhachHang/show-form-add" />">
						<h5 class="ft-plus-circle"> Thêm Khách Hàng </h5>
					</a>
				</div>
				<div class="x_content">
					...
					<table class="table table-striped"
						...
						<tbody>
							<c:forEach var="khachHang" items="${listKh}">
								<tr>
									<td style="text-align: left">${khachHang.maKh}</td>
									<td style="text-align: left">${khachHang.tenKh}</td>
									<td style="text-align: left">${khachHang.diaChi}</td>
									<td style="text-align: left">${khachHang.soDienThoai}</td>
									<td style="text-align: left">${khachHang.email}</td>

									<td><a
										style="width: 50px; high: 50px; border-color: #00E5EE; border-radius: 100%;"
										class="btn btn-outline-info "
										href="<c:url value="/QuanLyDuAn/KhachHang/show-form-edit/${khachHang.maKh}" />"
										title=""><i class="ft-edit"></i></a>
										<button
											style="width: 50px; high: 50px; border-color: #FF6A6A; border-radius: 100%;"
											data-href="<c:url value="/QuanLyDuAn/KhachHang/delete/${khachHang.maKh}" />"
