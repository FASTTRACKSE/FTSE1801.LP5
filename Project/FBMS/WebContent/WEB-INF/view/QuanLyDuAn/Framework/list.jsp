			...
			<div class="x_panel">
				<div class="x_title">
					<a class="btn btn-outline-success round btn-min-width mr-1 mb-1"
						href="<c:url value="/QuanLyDuAn/Framework/show-form-add" />">
						<h5 class="ft-plus-circle">Thêm Framework</h5>
					</a>
				</div>
				<div class="x_content">
						...
						<tbody>
							<c:forEach var="framework" items="${listFramework}" varStatus="count">
								<tr>
									...
									<th style="text-align: center" scope="row">${count.count}</th>
									<td style="text-align: center">${framework.maFramework}</td>
									<td style="text-align: center">${framework.tenFramework}</td>
									<td><a
										style="width: 50px; high: 50px; border-color: #00E5EE; border-radius: 100%;"
										class="btn btn-outline-info "
										href="<c:url value="/QuanLyDuAn/Framework/show-form-edit/${framework.maFramework }" />"
										title=""><i class="ft-edit"></i></a><button
											style="width: 50px; high: 50px; border-color: #FF6A6A; border-radius: 100%;"
											data-href="<c:url value="/QuanLyDuAn/Framework/delete/${framework.maFramework }" />"
