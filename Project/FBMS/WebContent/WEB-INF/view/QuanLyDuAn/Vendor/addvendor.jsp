	...
	<div class="content-wrapper">
		...
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-2">
				<h3 class="content-header-title mb-0">Thêm mới Vendor</h3>
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Thêm mới vendor</li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="justify-content-md-center" style="width: 95%">
                     ...
                     <form:form method="post" action="addnew" style="width: 95%;margin-left: 5%">
                       <h4 class="form-section"><i class="ft-clipboard"></i>Tên nhà cung cấp</h4>
                        <div class="row">
                          <div class="form-group col-md-6 mb-2">
                            <label for="projectinput6">Nhà cung cấp</label><br>
                        ...
                        <div class="col-sm-12 text-center">
							...
							<button type="submit" class="btn btn-outline-primary btn-lg mr-1 mb-1 btn-block round"><i class="fa fa-check-circle"></i> Thêm</button>
						</div>
