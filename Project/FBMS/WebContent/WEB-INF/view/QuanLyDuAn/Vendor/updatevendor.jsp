	...
	<div class="content-wrapper">
		...
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-2">
				<h3 class="content-header-title mb-0">Chỉnh sửa Vendor</h3>
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a
								href='<c:url value="/QuanLyDuAn/Vendor/list-vendor" />'>Danh Sách Vendor</a></li>
							<li class="breadcrumb-item active">Chỉnh sửa Vendor</li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="justify-content-md-center" style="width: 95%">
                     ...
                     <form:form method="post" action="/FBMS/QuanLyDuAn/Vendor/update" style="width: 95%;margin-left: 5%" modelAttribute="vendor">
                       <h4 class="form-section"><i class="ft-clipboard"></i>Nhà cung cấp</h4>
                        ...
                        <div class="col-sm-12 text-center">
							...
							<button type="submit" class="btn btn-outline-primary btn-lg mr-1 mb-1 btn-block round"><i class="fa fa-check-circle"></i>Sửa</button>
						</div>
