			...
			<div class="x_panel">
				<div class="x_title">
					<a class="btn btn-outline-success round btn-min-width mr-1 mb-1"
						href="<c:url value="/QuanLyDuAn/Database/show-form-add" />">
						...
						<tbody>
							<c:forEach var="database" items="${listDatabase}"
								...
								<tr>
									...
									<td style="text-align: left">${database.maDatabase}</td>
									<td style="text-align: center;">${database.tenDatabase}</td>
									<td><a
										style="width: 50px; high: 50px; border-color: #00E5EE; border-radius: 100%;"
										class="btn btn-outline-info "
										href="<c:url value="/QuanLyDuAn/Database/show-form-edit/${database.maDatabase }" />"
										title=""><i class="ft-edit"></i></a> 
										<button
											style="width: 50px; high: 50px; border-color: #FF6A6A; border-radius: 100%;"
											data-href="<c:url value="/QuanLyDuAn/Database/delete/${database.maDatabase }" />"
