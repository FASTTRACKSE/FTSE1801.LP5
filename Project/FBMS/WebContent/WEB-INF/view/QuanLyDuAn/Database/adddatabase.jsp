				...
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a
								href='<c:url value="/QuanLyDuAn/Database/list-database" />'>Danh dách database</a></li>
				...
				<div class="row">
					<form:form method="POST" action="addnew">
						<div class="form-group col-sm-6">
							...
							<form:errors path="maDatabase" cssClass="error" />
							<form:input path="maDatabase" class="form-control round"
