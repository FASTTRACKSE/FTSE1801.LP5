			...
			<div class="x_panel">
				<div class="x_title">
					<a class="btn btn-outline-success round btn-min-width mr-1 mb-1"
						href="<c:url value="/QuanLyDuAn/Domain/show-form-add" />">
						<h5 class="ft-plus-circle">Thêm Domain</h5>
					</a>
				</div>
				<div class="x_content">
					...
					<table class="table table-striped" style="text-align: center;background: white">
						<thead style="background: #AEEEEE">
							<tr>
								...
								<th style="width: 60%; text-align: center">Tên Nghiệp Vụ</th>
						...
						<tbody>
							<c:forEach var="domain" items="${listDomain}" varStatus="count">
								<tr>
									...
									<td style="text-align: center">${domain.maDomain}</td>
									<td style="text-align: center">${domain.tenDomain}</td>
									<td><a
										style="width: 50px; high: 50px; border-color: #00E5EE; border-radius: 100%;"
										class="btn btn-outline-info "
										href="<c:url value="/QuanLyDuAn/Domain/show-form-edit/${domain.maDomain }" />"
										title=""><i class="ft-edit"></i></a>
										<button
											style="width: 50px; high: 50px; border-color: #FF6A6A; border-radius: 100%;"
											data-href="<c:url value="/QuanLyDuAn/Domain/delete/${domain.maDomain }" />"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Bạn muốn xóa Nghiệp vụ này???</p>
			</div>
