	...
	<div class="content-wrapper">
		...
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-2">
				<h3 class="content-header-title mb-0">Trạng thái dự án</h3>
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a
								href='<c:url value="/QuanLyDuAn/TrangThai/list-trangThai" />'>Trạng thái dự án</a> </li>
						</ol>
					</div>
				</div>
			</div>
			...
			<div class="x_panel">
				<div class="x_title">
					<a class="btn btn-outline-success round btn-min-width mr-1 mb-1"
						href="<c:url value="/QuanLyDuAn/TrangThai/show-form-add" />">
						<h5 class="ft-plus-circle"> Thêm trạng Thái </h5>
					</a>
				</div>
					...
					<table class="table table-striped"	style="text-align: center; background: white">
						<thead style="background: #AEEEEE">
							<tr>
								...
								<th style="width: 40%; text-align: center"> Tên trạng thái</th>
								<th style="text-align: center"> Chức năng </th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="trangThai" items="${listTrangThai}" >
								<tr>
									<th style="text-align: center;"> ${trangThai.maTrangThai} </th>
									<td style="text-align: center;"> ${trangThai.tenTrangThai} </td>

									<td><a
										style="width: 50px; high: 50px; border-color: #00E5EE; border-radius: 100%;"
										class="btn btn-outline-info "
										href="<c:url value="/QuanLyDuAn/TrangThai/show-form-edit/${trangThai.maTrangThai}" />"
										title=""><i class="ft-edit"></i></a>
										<button
											style="width: 50px; high: 50px; border-color: #FF6A6A; border-radius: 100%;"
											data-href="<c:url value="/QuanLyDuAn/TrangThai/delete/${trangThai.maTrangThai}" />"
