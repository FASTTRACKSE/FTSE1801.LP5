	...
	<div class="content-wrapper">
		...
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-2">
				<h3 class="content-header-title mb-0">Vai trò thành viên</h3>
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a
								href='<c:url value="/QuanLyDuAn/VaiTro/list-vaiTro" />'>Vai trò thành viên</a></li>
						</ol>
					</div>
				</div>
			</div>
			...
			<div class="x_panel">
				<div class="x_title">
					<a class="btn btn-outline-success round btn-min-width mr-1 mb-1"
						href="<c:url value="/QuanLyDuAn/VaiTro/show-form-add" />">
						<h5 class="ft-plus-circle"> Thêm vai trò </h5>
					</a>
				</div>
				<div class="x_content">
					...
					<table class="table table-striped"
						...
						<thead style="background: #AEEEEE">
							<tr>
								<th style="text-align: center"> Mã vai trò </th>
								<th style="width: 60%; text-align: center"> Tên vai trò </th>
						...
						<tbody>
							<c:forEach var="vaiTro" items="${listVaiTro}">
								<tr>
									<td style="text-align: center">${vaiTro.maVaiTro}</td>
									<td style="text-align: center">${vaiTro.tenVaiTro}</td>

									<td><a
										style="width: 50px; high: 50px; border-color: #00E5EE; border-radius: 100%;"
										class="btn btn-outline-info "
										href="<c:url value="/QuanLyDuAn/VaiTro/show-form-edit/${vaiTro.maVaiTro}" />"
										title=""><i class="ft-edit"></i></a>
										<button
											style="width: 50px; high: 50px; border-color: #FF6A6A; border-radius: 100%;"
											data-href="<c:url value="/QuanLyDuAn/VaiTro/delete/${vaiTro.maVaiTro}" />"
