				...
				<div class="row">
					<form:form method="POST" action="addnew">
						...
						<div class="form-group col-sm-6">
							<label> Mã vai trò </label><br>
							<p Class="error">${messageName}</p>
							<form:errors path="maVaiTro" cssClass="error" />
							<form:input path="maVaiTro" class="form-control round" placeholder="Mã Vai trò" />
						</div>
						...
						<div class="form-group col-sm-6">
							...
							<form:input path="tenVaiTro" class="form-control round" placeholder="Tên Vai trò" />
						</div>
