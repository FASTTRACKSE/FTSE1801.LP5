				...
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a
								href='<c:url value="/QuanLyDuAn/CongNghe/list-congNghe" />'>Danh Sách Công Nghệ</a></li>
			...
			<div class="x_panel">
				<div class="x_title">
					<a class="btn btn-outline-success round btn-min-width mr-1 mb-1"
						href="<c:url value="/QuanLyDuAn/CongNghe/show-form-add" />">
						<h5 class="ft-plus-circle">Thêm Công Nghệ</h5>
					</a>
				</div>
				<div class="x_content">
					...
					<table class="table table-striped" style="text-align: center;background: white">
						<thead style="background: #AEEEEE">
							<tr>
								...
								<th style="text-align: center">Mã Công Nghệ</th>
								<th style="width: 60%; text-align: center">Tên Công Nghệ</th>
								<th style="text-align: center">Chức Năng</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="congnghe" items="${listCongNghe}"
								varStatus="count">
								<tr>

									<th scope="row">${count.count}</th>
									<td style="text-align: center">${congnghe.maCongNghe}</td>
									<td style="text-align: center">${congnghe.tenCongNghe}</td>
									<td><a
										style="width: 50px; high: 50px; border-color: #00E5EE; border-radius: 100%;"
										class="btn btn-outline-info "
										href="<c:url value="/QuanLyDuAn/CongNghe/show-form-edit/${congnghe.maCongNghe }" />"
										title=""><i class="ft-edit"></i></a> 
										<button
											style="width: 50px; high: 50px; border-color: #FF6A6A; border-radius: 100%;"
											data-href="<c:url value="/QuanLyDuAn/CongNghe/delete/${congnghe.maCongNghe }" />"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Bạn muốn xóa Công Nghệ này???</p>
			</div>
