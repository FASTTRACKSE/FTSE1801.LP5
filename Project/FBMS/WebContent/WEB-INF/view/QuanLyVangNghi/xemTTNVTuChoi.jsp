	...
	<div class="content-wrapper">
		...
		<div class="content-header row">
			<div>
				<div class="col-md-5">
					<h1>
						<a href='<c:url value="/QuanLyVangNghi/danhsachbituchoi" />'><i
			...
			<div class="continer">
				<br> <label>Mã đơn</label> <input class="form-control"
					value="${list.id}" readonly /> <label>Mã nhân viên</label> <input
				...
				<label>Ghi chú</label> <input class="form-control"
					...
					class="form-control" value="${list.trangThai.trangThai}" readonly />
