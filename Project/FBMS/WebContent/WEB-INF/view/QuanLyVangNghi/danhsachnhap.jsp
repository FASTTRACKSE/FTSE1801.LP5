								...
								<c:forEach var="nv" items="${danhsachnhap}">
									<tr>
										...
										<td><h2>
											...
											<h2>
												<a href="viewNhap/${nv.idDonXinPhep }"><i class="icon-eye"></i></a>
											</h2>
											<h2>
								...
								<ul class="pagination">
									<c:if test="${currentPage != 1}">
										<li class="paginate_button page-item first"
											...
											href="<%=request.getContextPath()%>/QuanLyVangNghi/danhsachnhap?page=1"
											aria-controls="DataTables_Table_5" class="page-link">Trang Đầu</a></li>

										<li class="paginate_button page-item previous"
											id="DataTables_Table_5_previous"><a
											href="<%=request.getContextPath()%>/QuanLyVangNghi/danhsachnhap?page=${currentPage-1}"
									...
									<li class="paginate_button page-item "><a
										href="<%=request.getContextPath()%>/QuanLyVangNghi/danhsachnhap?page=${currentPage}"
									...
									<li class="paginate_button page-item last"
										...
										href="<%=request.getContextPath()%>/QuanLyVangNghi/danhsachnhap?page=${lastPage}"
