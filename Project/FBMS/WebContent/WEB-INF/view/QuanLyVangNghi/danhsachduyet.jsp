				...
				<tbody>
					<c:forEach var="nv" items="${danhsachduyet}">
						<tr>
							...
							<td><h2>
									<a href="deleteBrowse/${nv.idDonXinPhep }"> <i class='fa fa-trash'
										onclick="return confirm('Bạn có muốn xóa sinh viên này?');"></i></a>
								</h2>
								<h2>
									<a href="viewDuyet/${nv.idDonXinPhep }"><i class="icon-eye"></i></a>
								</h2></td>
						</tr>
					</c:forEach>
				</tbody>
					...
					<ul class="pagination">
						<c:if test="${currentPage != 1}">
							<li class="paginate_button page-item first"
								...
								href="<%=request.getContextPath()%>/QuanLyVangNghi/danhsachduyet?page=1"
								aria-controls="DataTables_Table_5" class="page-link">Trang Đầu</a></li>

							<li class="paginate_button page-item previous"
								id="DataTables_Table_5_previous"><a
								href="<%=request.getContextPath()%>/QuanLyVangNghi/danhsachduyet?page=${currentPage-1}"
						...
						<li class="paginate_button page-item "><a
							href="<%=request.getContextPath()%>/QuanLyVangNghi/danhsachduyet?page=${currentPage}"
						...
						<li class="paginate_button page-item last"
							...
							href="<%=request.getContextPath()%>/QuanLyVangNghi/danhsachduyet?page=${lastPage}"
