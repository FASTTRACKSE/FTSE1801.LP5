		...
		<div class="content-header row">
			...
			<div class="content-header-right col-md-3 col-xs-12">
				<div role="group" aria-label="Button group with nested dropdown"
					...
					<a href="<c:url value = "/QuanLyThoiGian/add"/>"
							...
							<div class="table-responsive">
								...
								<div id="datatable_wrapper"
									...
									<div class="row">
										<div class="col-md-12">
											<table id="datatable"
												class="table table-striped table-bordered dataex-res-constructor noT0-footer dataTable"
												...
												<c:forEach var="logwork" items="${listLogwork}">
													<tr>
														<td>${logwork.nhanVien.hoDem}${logwork.nhanVien.ten}</td>
														<td>${logwork.phongBan.tenPhongBan}</td>
														<td>${logwork.duAn}</td>
														<td>${logwork.vaiTroNV}</td>
														<td>${logwork.time}</td>
														<td>${logwork.date}</td>
														<td>${logwork.moTaCongViec}</td>
														<td><a href="<c:url value = ""/>"><i
																class="fa fa-eye"></i></a><a
															href="<c:url value = "/QuanLyThoiGian/edit/${logwork.id}"/>"><i
