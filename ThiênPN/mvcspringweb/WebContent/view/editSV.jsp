...
<body>
 <h1>Edit Sinh Viên</h1>
	<form:form modelAttribute="add" method="post" action="/mvcspringweb/EditSV">
		<table>
			<tr>
				<td></td>
			...
			<tr>
				...
				<td><form:hidden path="listDiem[0].id" />
				<form:input path="listDiem[0].monHoc" /></td>
			</tr>
			<tr>
				<td><spring:message code="diem" /> :</td>
				<td><form:input path="listDiem[0].diem" /></td>
			</tr>
			<tr>
				<td></td>
